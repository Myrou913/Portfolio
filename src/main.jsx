...
const projects = [
  { id: 'portfolio', number: '01', title: 'My Portfolio', type: 'Personal portfolio', description: 'A personal portfolio site built with React and Vite, featuring project showcases, certificates, a contact form, and a live public comments section powered by Supabase.', tools: ['React', 'JavaScript', 'CSS', 'Supabase'], features: ['Project showcase', 'Live comments', 'Contact form'], github: 'https://github.com/Myrou913/Portfolio.git', color: 'blue', image: '/assets/PortfolioScreenshot.png', demo: '/demos/demoPortfolio.mp4' },
  { id: 'sonede', number: '02', title: 'SCOC', type: 'Complaint management', description: 'A full-stack complaint-management platform for reporting and tracking water-service issues.', tools: ['SQL', 'JavaScript', 'HTML', 'CSS'], features: ['Complaint reporting', 'Case tracking', 'Clear self-service flow'], github: 'https://github.com/Myrou913/sonede-complaints.git', color: 'blue', image: '/assets/SonedeScreenshot.png', demo: '/demos/demoSonede.mp4' },
  { id: 'urgentflow', number: '03', title: 'UrgentFlow', type: 'Healthcare platform', description: 'A healthcare interface designed to help people find hospitals and emergency services faster.', tools: ['JavaScript', 'HTML', 'CSS'], features: ['Hospital discovery', 'Emergency navigation', 'Responsive experience'], github: 'https://github.com/Myrou913/UrgentFlow.git', color: 'pink', image: '/assets/UrgentFlowScreenshot.jpeg', demo: '/demos/demoUrgentFlow.mp4' },
  { id: 'shopflow', number: '04', title: 'ShopFlow', type: 'E-commerce experience', description: 'A modern marketplace with product discovery, a shopping cart, and JWT authentication.', tools: ['React', 'JavaScript', 'Spring Boot', 'JWT'], features: ['Product browsing', 'Cart management', 'Secure sign-in'], github: 'https://github.com/Myrou913/shopflow.git', color: 'lime', image: '/assets/ShopFlowScreenshot.png', demo: '/demos/demoShopFlow.mp4' },
  { id: 'pomodoro', number: '05', title: 'Pomodoro Timer', type: 'Focus companion', description: 'A warm productivity timer created for intentional focus and restorative breaks.', tools: ['JavaScript', 'HTML', 'CSS'], features: ['Focus and break modes', 'Start, stop, reset', 'Minimal interface'], github: 'https://github.com/Myrou913/PomodoroTimer.git', color: 'orange', image: '/assets/PomodoroTimerScreenshot.jpeg', demo: '/demos/demoPomodoro.mp4' }
];
